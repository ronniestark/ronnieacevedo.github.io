  ...
  return (
    <div className="animate-fade-in max-w-5xl mx-auto py-8">
      <h2 className="text-3xl font-bold mb-10 text-white flex items-center gap-3 drop-shadow-md">
        <BrainCircuit className="text-blue-400" size={32} /> Filosofía de Desarrollo
      </h2>
      
      <div className="grid md:grid-cols-2 gap-6">
        
        {/* Diseño y Modelado Previo */}
        <div className="group bg-slate-900/60 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-emerald-500/50 hover:shadow-emerald-500/10 hover:-translate-y-1 transition-all duration-300 shadow-xl">
          <h3 className="text-xl font-semibold text-white mb-3 flex items-center gap-2 group-hover:text-emerald-400 transition-colors">
            <Database className="text-emerald-500" size={24} /> 
            Modelado Estratégico y Datos
          </h3>
        ...
        {/* DDD */}
        <div className="group bg-slate-900/60 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-purple-500/50 hover:shadow-purple-500/10 hover:-translate-y-1 transition-all duration-300 shadow-xl">
          <h3 className="text-xl font-semibold text-white mb-3 flex items-center gap-2 group-hover:text-purple-400 transition-colors">
        ...
        {/* Arquitectura Limpia */}
        <div className="group bg-slate-900/60 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-blue-500/50 hover:shadow-blue-500/10 hover:-translate-y-1 transition-all duration-300 shadow-xl">
          <h3 className="text-xl font-semibold text-white mb-3 flex items-center gap-2 group-hover:text-blue-400 transition-colors">
            <Layers className="text-blue-500" size={24} /> 
            Arquitectura Limpia y Evolutiva
          </h3>
          <p className="text-slate-300 leading-relaxed">
        ...
        <div className="group bg-slate-900/60 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-red-500/50 hover:shadow-red-500/10 hover:-translate-y-1 transition-all duration-300 shadow-xl">
          <h3 className="text-xl font-semibold text-white mb-3 flex items-center gap-2 group-hover:text-red-400 transition-colors">
            <ShieldCheck className="text-red-500" size={24} /> 
            Seguridad, Rendimiento y Testing
          </h3>
          <p className="text-slate-300 leading-relaxed">
        ...
        <div className="group bg-slate-900/60 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 hover:border-cyan-500/50 hover:shadow-cyan-500/10 hover:-translate-y-1 transition-all duration-300 shadow-xl md:col-span-2 lg:col-span-2">
          ...
          <p className="text-slate-300 leading-relaxed md:w-3/4">
